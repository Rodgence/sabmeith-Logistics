    ...
    <div class="row g-3 align-items-center">
        <div class="col-sm-6">
            ...
            <div class="bg-success p-3 rounded-4 text-center wow fadeIn" data-wow-delay="0.5s">
                ...
                <h3 class="text-white mb-1" data-toggle="counter-up">250</h3>
                <p class="text-white mb-0 small">Fleet Size</p>
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="bg-info p-3 rounded-4 text-center wow fadeIn" data-wow-delay="1.1s">
                <i class="fa fa-building fa-2x text-white mb-2"></i>
                <h3 class="text-white mb-1" data-toggle="counter-up">5</h3>
                <p class="text-white mb-0 small">Offices</p>
            </div>
        </div>
    </div>
</div>
