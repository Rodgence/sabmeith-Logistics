...
<section class="content-section py-5">
  <div class="container">
    ...
    <!-- GCLA Registration & Mining Reagents -->
    <div class="row align-items-center mb-5">
      ...
      <div class="col-md-6">
        <h3>Energy &amp; Mining Logistics</h3>
        <p>
          As a <strong>GCLA (Government Chemist Laboratory Agency) registered and certified transporter</strong>, Sabmeith Freight Limited provides logistics support for the energy and mining sector by facilitating the transportation of various mining reagents:
        </p>
        ...
        <p>
          We also handle the transportation of extracted raw materials such as <strong>Copper, Cobalt, Zinc, Manganese</strong>, and containerized cargo.
        </p>
      </div>
    </div>
...
<section class="py-5 bg-primary text-white text-center">
  <div class="container">
    ...
    <a href="https://wa.me/255775999000" class="btn btn-light btn-lg">Get in Touch</a>
  </div>
</section>
